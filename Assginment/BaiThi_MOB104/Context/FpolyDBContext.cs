...
namespace BaiThi_MOB104.Context
{
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=HIEUPHAMVAN\\SQLEXPRESS;Initial Catalog=FINALASS_FPOLYSHOP_SM22_BL2_DUNGNA29;Persist Security Info=True;User ID=hieupvph27565;Password=hieupvph27565");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ChiTietSp>(entity =>
            {
                ...
                entity.HasOne(d => d.IdDongSpNavigation)
                    ...
                    .HasConstraintName("FK__ChiTietSP__IdDon__2CF2ADDF");

                entity.HasOne(d => d.IdMauSacNavigation)
                    .WithMany(p => p.ChiTietSps)
                    .HasForeignKey(d => d.IdMauSac)
                    .HasConstraintName("FK__ChiTietSP__IdMau__2BFE89A6");

                entity.HasOne(d => d.IdNsxNavigation)
                    .WithMany(p => p.ChiTietSps)
                    .HasForeignKey(d => d.IdNsx)
                    .HasConstraintName("FK__ChiTietSP__IdNsx__2B0A656D");

                entity.HasOne(d => d.IdSpNavigation)
                    .WithMany(p => p.ChiTietSps)
                    .HasForeignKey(d => d.IdSp)
                    .HasConstraintName("FK__ChiTietSP__IdSP__2A164134");
            });
            ...
            modelBuilder.Entity<GioHang>(entity =>
            {
                ...
                entity.HasOne(d => d.IdKhNavigation)
                    ...
                    .HasConstraintName("FK__GioHang__IdKH__282DF8C2");
            });
            ...
            modelBuilder.Entity<HoaDon>(entity =>
            {
                ...
                entity.HasOne(d => d.IdKhNavigation)
                    ...
                    .HasForeignKey(d => d.IdKh)
                    .HasConstraintName("FK__HoaDon__IdKH__2739D489");

                entity.HasOne(d => d.IdNvNavigation)
                    .WithMany(p => p.HoaDons)
                    .HasForeignKey(d => d.IdNv)
                    .HasConstraintName("FK__HoaDon__IdNV__29221CFB");
            });
